const CACHE='smart-coordi-v3';
const ASSETS=['./','./index.html','./styles-v2.css','./app-v2.js?v=0275570','./db-v2.js','./quote-parser.js','./transcript-analyzer.js','./whisper-worker.js','./manifest.webmanifest'];
