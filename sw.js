const CACHE='smart-coordi-v2';
const ASSETS=['./','./index.html','./styles-v2.css','./app-v2.js','./db-v2.js','./quote-parser.js','./transcript-analyzer.js','./whisper-worker.js','./manifest.webmanifest'];
