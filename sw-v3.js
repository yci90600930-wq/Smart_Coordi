const CACHE='smart-coordi-v5';
const ASSETS=['./','./index.html','./styles-v2.css','./app-v2.js?v=asr2','./db-v2.js','./quote-parser.js','./transcript-analyzer.js','./whisper-worker.js?v=asr2','./manifest.webmanifest'];
